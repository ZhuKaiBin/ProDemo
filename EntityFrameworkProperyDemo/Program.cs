...
namespace EntityFrameworkProperyDemo
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            ModbusCapabilityResponseDto modbus = new ModbusCapabilityResponseDto() {ModbusCapID="123" };
    ...
    public class DeviceDescriptionDto
    {
        ...
        public ModbusCapabilityResponseDto ModbusCapability { get; private set; } = new ModbusCapabilityResponseDto();
