...
namespace MediatRDemo
{
    ...
    {
        public HourseSeller(HourseMediator mediator) : base(mediator)
        {
    ...
    {
        public HorseBuyer(HourseMediator mediator) : base(mediator)
        {
        }
    ...
    public class Ajk : HourseMediator
    {
        ...
        public HorseBuyer Buyer { set => buyer = value; }
        public HourseSeller Seller { set => seller = value; }
